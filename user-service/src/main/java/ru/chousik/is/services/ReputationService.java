...
public class ReputationService {
    ...
    public void updateReputationForLessor(UUID lessorId) {
        updateRating(lessorId, reviewRepository.findAllVisibleByLessor(lessorId), ReviewAuthorRole.LESSEE);
    }

    @Transactional
    public void updateReputationForLessee(UUID lesseeId) {
        updateRating(lesseeId, reviewRepository.findAllVisibleByLessee(lesseeId), ReviewAuthorRole.LESSOR);
    }
