...
const API_BASE = (import.meta.env.VITE_AUTH_BASE || '/auth-service').replace(/\/$/, '');
const ADMIN_API_BASE = (import.meta.env.VITE_ADMIN_API_BASE || '/admin-service/api/admin').replace(/\/$/, '');
