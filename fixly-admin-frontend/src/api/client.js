...
const API_BASE = (import.meta.env.VITE_AUTH_BASE || 'http://localhost:8075/auth-service').replace(/\/$/, '');
const ADMIN_API_BASE = (import.meta.env.VITE_ADMIN_API_BASE || 'http://localhost:8075/admin-service/api/admin').replace(/\/$/, '');
